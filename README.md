...
- Contracts - Andex smart contracts such as the router Contracts
- SDKs - Andex integrations such as the *sdk-core* and the *Swap Widget*
- APIs - The Andex APIs such the *Subgraph API*
...
A good example is the [Router Smart Contracts](./docs/contracts/router/overview.md).

### Guides
> Guides should follow the **Principles of a Good Guide**:
- A guide corresponds to a reusable piece of code that demonstrates a single concept in the Andex ecosystem.
...
A good example is the [SDK Guides](./docs/sdk/v1/guides/01-quick-start.md).

### Technical References
This should contain the technical reference for the exported interfaces. A good example is the [SDK](./docs/sdk/v1/reference/overview).
These files can be created using the [guides below](#how-to-create-a-technical-reference).

# Contributing to Andex Docs
...
Let's walk through an example by considering the *amm* smart contract:
-  Did I pick the right section for the product? 
    - In this case, [contracts](./docs/contracts/) 
- Did I create the product folder? 
    - In this case, [yes](./docs/contracts/amm/)
- Did I introduce any new concepts? 
    - No
- Did I include an Overview of the product under */contracts/amm/overview* ?
    - Yes, I did add them [here](./docs/contracts/amm/overview.md)
- Did I include Guides of the product under *contracts/amm/guides* ?
    - No, they should be added [here](./docs/contracts/amm/guides)
- Did I include Technical Reference of the product under *contracts/amm/reference* ?
    - Yes I added them [here](./docs/contracts/amm/reference)
- Did I open a PR using the the [Contributing](./CONTRIBUTING.md) guidelines?
    - Yes
...
- Edit config.json file if needed:
    ...
    - Sitemap url from updated website: eg for docs: https://docs.andex.finance/sitemap.xml
    - Use "docs" as the index name
...
## Deployment
The application automatically deployed to production using [Vercel](https://vercel.com/andex/docs) upon merge into **main**.